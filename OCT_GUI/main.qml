...
ApplicationWindow {
    ...
    property var benchmarkWindow;
    property var viewAScanWindow;
    ...
    Component.onCompleted: {
        //var viewascancomponent = Qt.createComponent("QML_ViewAscan.qml")
        //viewAScanWindow = viewascancomponent.createObject(viewAScanWindow)
        //viewAScanWindow.visible = true
                    ...
                    Item{
                        ...
                        Image {
                            ...
                            function slotUpdateBScanImage(){
                                bscanCanvas.source = "image://bscanProvider/intensity?" + Math.random();
                                enFaceImage.source = "image://enFaceProvider/intensity?" + Math.random();
                            }

                            Component.onCompleted: {
                                bscanCanvas.enfaceChanged(enface1MouseArea.y, enface2MouseArea.y);
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    drag.maximumX: bscanCanvas.height*.98;
                                    drag.minimumX: bscanCanvas.height*.02;
                                    onReleased: {
                                        bscanCanvas.enfaceChanged(enFace1.y, enFace2.y);
                                    }
                                }
                            }
        ...
        Tab{
            ...
            Item{
                ...
                Timer {
                    ...
                    running: true
                    onTriggered: {
                        var benchmark = octBackend.Benchmarks;
