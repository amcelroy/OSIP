...
#include "signalprocessingpipelinestages_global.h"
#include "Pipeline/pipelinestage.h"
#include "fftw3.h"
#include "windowmaker.h"

class SIGNALPROCESSINGPIPELINESTAGESSHARED_EXPORT OCTPipelineStageCPU : public PipelineStage<unsigned short, float>
{
